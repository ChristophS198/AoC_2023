...
namespace D2{
    ...
    bool Dijkstra2::updateDijkstraNode(const Node &n, ShortestPathTable &shortest_path_table, std::vector<Node> &reachable_pts) const
    {
    ...
    void Dijkstra2::sort(std::vector<Node> &reachable_pts) const
    {
